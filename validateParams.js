 ...
 * ```
 *
 * @alias module:validateParams.valdiate
...
validateParams.Result = function(){
    /**
     * A referece to the parameter list passed to `validateParams.validate()`.
     * @private
     * @type {Object[]}
     */
    this._parameterList = [];
    ...
    /**
     * A reference to the constraint list passed to `validateParams.validate()`.
     * @private
    ...
    /**
     * A reference to the options passed through to the `validate()` function
     * from validate.js via `validateParams.validate()`.
     * @private
     * @type {Object}
     */
    this._options = {};
     ...
     * `validateParams.validate()` and passed to the `validate()` function from
     * validate.js.
     * @private
     * @type {Object}
     */
    ...
    /**
     * A reference to the return value from the `validate()` function from
     * validate.js, the type and structure of the returned value will be
